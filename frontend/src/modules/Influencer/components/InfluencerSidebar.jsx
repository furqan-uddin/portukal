...
const InfluencerSidebar = ({ isOpen, setIsOpen, isCollapsed }) => {
    ...
    return (
        <>
            ...
            <aside 
                className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white h-screen flex flex-col flex-shrink-0 border-r border-slate-800 transition-transform duration-300 ease-in-out 
            ...
            >
                ...
                <div className="p-4 bg-slate-800/60 m-3 rounded-2xl border border-slate-800 flex items-center gap-3 flex-shrink-0">
